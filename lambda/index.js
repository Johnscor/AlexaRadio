...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    const speechText = 'Esta habilidade reproduz um fluxo de áudio quando é iniciada. Não possui nenhuma funcionalidade adicional';
...
const AboutIntentHandler = {
  ...
  handle(handlerInput) {
    const speechText = 'Esta é uma habilidade de streaming de áudio para rádio criada por john';
